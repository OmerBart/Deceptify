...
def lip_sync_inference(checkpoint_path, face, audio_path, outfile='results/result_voice.mp4', static=False, fps=25.0,
...
# Example usage:
# lip_sync_inference('checkpoints/wav2lip_gan.pth', 'Videos/result.mp4', 'Audios/testAudio.wav')

if __name__ == '__main__':
    lip_sync_inference('checkpoints\\wav2lip_gan.pth', 'Videos\\result.mp4',
                       'Audios\\testAudio.wav')
