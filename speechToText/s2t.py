...
if __name__ == '__main__':
    try:
        filename = input("Enter file name: ") + '.json'  # Opening some file to write the transcript
        filename = 'conversations/' + filename  # Navigate the target file to the directory.
